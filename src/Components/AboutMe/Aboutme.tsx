  ...
  return (
    <>
      ...
      <p>
        ...
        solutions. I crafted a custom C#.NET/Typescript/React cloud application for streamlining QA processes and
        boosting developer productivity. My role involved juggling various technologies and always staying ahead of the
        curve to deliver reliable and efficient applications with a focus on high quality and extensive test coverage.
      </p>
      <p>
        Prior to that, I cut my teeth at American National, starting as an eager intern and quickly rising to lead
        roles. I had my hands on developing pivotal C# ASP.NET APIs that became central to the company's operations. My
        journey there included implementing robust content management solutions and driving best practices in unit
        testing and dependency injection. Leading and mentoring teams, I guided architectural decisions and ensured
